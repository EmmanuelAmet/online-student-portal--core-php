...
<body class="bg-warning" style="background-image: url('../images/students.jpg'); background-size: cover;">
 <div class="container p-5">
   ...
   <div class="card card-body p-5" style="border-radius: 50px; opacity: 80%">
     ...
     <form class="user" action="login.php" method="POST">
       ...
       <input type="submit" name="Login" class="btn btn-warning btn-user btn-block" value="Login">
       <hr>
